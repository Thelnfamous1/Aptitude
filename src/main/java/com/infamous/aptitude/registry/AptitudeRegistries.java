...
public class AptitudeRegistries {
    ...
    public static final Supplier<IForgeRegistry<Codec<? extends BehaviorMaker>>> BEHAVIOR_MAKER_SERIALIZERS =
            DEFERRED_BEHAVIOR_MAKER_SERIALIZERS.makeRegistry(() -> new RegistryBuilder<Codec<? extends BehaviorMaker>>().disableSaving().disableSync());
    ...
    public static final Supplier<IForgeRegistry<Codec<? extends PredicateMaker<?>>>> PREDICATE_MAKER_SERIALIZERS =
            DEFERRED_PREDICATE_MAKER_SERIALIZERS.makeRegistry(() -> new RegistryBuilder<Codec<? extends PredicateMaker<?>>>().disableSaving().disableSync());
    ...
    public static final Supplier<IForgeRegistry<Codec<? extends FunctionMaker<?, ?>>>> FUNCTION_MAKER_SERIALIZERS =
            DEFERRED_FUNCTION_MAKER_SERIALIZERS.makeRegistry(() -> new RegistryBuilder<Codec<? extends FunctionMaker<?, ?>>>().disableSaving().disableSync());
    ...
    public static final Supplier<IForgeRegistry<Codec<? extends BiPredicateMaker<?, ?>>>> BIPREDICATE_MAKER_SERIALIZERS =
            DEFERRED_BIPREDICATE_MAKER_SERIALIZERS.makeRegistry(() -> new RegistryBuilder<Codec<? extends BiPredicateMaker<?, ?>>>().disableSaving().disableSync());
    ...
    public static final Supplier<IForgeRegistry<Codec<? extends BiConsumerMaker<?, ?>>>> BICONSUMER_MAKER_SERIALIZERS =
            DEFERRED_BICONSUMER_MAKER_SERIALIZERS.makeRegistry(() -> new RegistryBuilder<Codec<? extends BiConsumerMaker<?, ?>>>().disableSaving().disableSync());
    ...
    public static final Supplier<IForgeRegistry<Codec<? extends BrainModifier>>> BRAIN_MODIFIER_SERIALIZERS =
            DEFERRED_BRAIN_MODIFIER_SERIALIZERS.makeRegistry(() -> new RegistryBuilder<Codec<? extends BrainModifier>>().disableSaving().disableSync());
