...
public interface BehaviorMaker
{
    ...
    static <E extends LivingEntity> List<Pair<? extends BehaviorControl<? super E>, Integer>> makeWeightedBehaviors(List<Pair<? extends BehaviorMaker, Integer>> weightedBehaviorMakers){
